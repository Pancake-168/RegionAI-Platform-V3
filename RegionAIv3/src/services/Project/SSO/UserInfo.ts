...
export async function GetIMUserInfo(
  username: string,
): Promise<ApiResult<GetIMUserInfoApiResponse>> {
...
export async function updateIDmapInGetIMUserInfo(
